        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/transyncpro" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/company/transyncpro" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a 
                href="https://www.facebook.com/transyncpro" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/demo" className="text-gray-400 hover:text-white transition-colors">Request Demo</Link></li>
            </ul>
          </div>
